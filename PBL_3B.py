...
class Principal(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        Window.size= (400,600)
        self.som_aeronave=SoundLoader.load('somAeronave.wav')
        self.som_carroca=SoundLoader.load('somCarroca.wav')
        self.som_submarino=SoundLoader.load('somSubmarino.wav')
        self.som_trem=SoundLoader.load('somTrem.wav')
        self.som_triciclo=SoundLoader.load('somTriciclo.wav')
        self.som_tuctuc=SoundLoader.load('somTuctuc.wav')
